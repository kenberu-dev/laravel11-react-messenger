...
export default function MessageOptionsDropdown({ message }) {
    ...
    const onMessageDelete = () => {
        ...
        // Send axios post request to delete message and show notification on sucess
        axios
    ...
    return (
        <div className="absolute right-full text-gray-100 top-1/2 -translate-y-1/2">
            <Menu as="div" className="relative inline-block text-left">
                ...
                >
                    <Menu.Items className="absolute left-0 mt-2 w-48 rounded-md bg-gray-800 shadow-lg z-10">
